CREATE TABLE [telemetry].[VcsPluginTelemetry] (
    ...
    [DownloadedSourcesSize] BIGINT         NULL,
    [CommittedSize]         BIGINT         NULL,
    [CreatedBranchName]     NVARCHAR (255) NULL,
    CONSTRAINT [PK_VcsPluginTelemetry] PRIMARY KEY CLUSTERED ([Id] ASC)
);
