intellisense.annotate(jQuery, {
  'ajax': function() {
    ...
    ///   <param name="settingsView" type="PlainObject">A set of key/value pairs that configure the Ajax request. All settingsView are optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settingsView ) below for a complete list of all settingsView.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
    /// <signature>
    ///   <summary>Perform an asynchronous HTTP (Ajax) request.</summary>
    ///   <param name="settingsView" type="PlainObject">A set of key/value pairs that configure the Ajax request. All settingsView are optional. A default can be set for any option with $.ajaxSetup().</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
